...
In this file differences between a reference sensor to the others are visualised
Here I took Sensor_3 (3m above ground) as reference Sensor. The choice roots from measurement conventions for devices at this height. Additionally, Bias-correction was performed at the same height, whereas a cross-validation between all sensors where not performed.
...
```{r}
lap = read.table("../data/Distanz_&_Hohe_GR_2.csv", sep = ";", header = T)
```
## New dataset
...
#Open jpeg
jpeg("../Images/Var_between_sensors/temp.jpeg", height = 486, width = 780, res = 108)
...
#Open jpeg
jpeg("../Images/Var_between_sensors/humidity.jpeg", height = 486, width = 780, res = 108)
